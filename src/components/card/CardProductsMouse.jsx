...
export default function CardProductsMouse(prop) {
  ...
  return (
    <>  
      ...
      <div className=" space-y-2  grow">
        <h4 className="text-black text-left px-2 pt-2 pb-10 ">{prop.name}</h4>
        <div className="items-center w-full absolute bottom-0 p-2 flex flex-row justify-between">
          ...
          <div className="flex flex-row items-center justify-start">
            ...
            <p  className={ active ?'className="text-xl font-bold text-red-500 ':'text-xl font-bold'} >{prop.price}$</p>
          </div>
        </div>
      </div>
